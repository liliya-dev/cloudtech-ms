...
export const Default = () => (
  <Video provider="static" videoId="/video/mawla-video-hero_v3.mp4" />
);

export const AutoPlay = () => (
  <Video provider="static" videoId="/video/mawla-video-hero_v3.mp4" autoPlay />
);

export const Loop = () => (
  <Video provider="static" videoId="/video/mawla-video-hero_v3.mp4" loop />
);
